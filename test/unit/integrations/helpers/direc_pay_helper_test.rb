...
class DirecPayHelperTest < Test::Unit::TestCase
  ...
  def test_status_update_in_test_mode
    params = "dummy-authorization|1234|http://localhost/notify"
    DirecPay::Status.any_instance.expects(:ssl_get).with("https://test.timesofmoney.com/direcpay/secure/dpMerchantTransaction.jsp?requestparams=#{CGI.escape(params)}")
